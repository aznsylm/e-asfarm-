    ...
    <div class="with-vertical">
        ...
        <nav class="navbar navbar-expand-lg p-0">
                        ...
                        <div class="dropdown-menu dropdown-menu-nav dropdown-menu-animate-up py-0 overflow-hidden" aria-labelledby="drop2">
                            <div class="position-relative">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <img src="<?= base_url('assets/images/backgrounds/mega-dd-bg.jpg'); ?>" alt="mega-dd" class="img-fluid mega-dd-bg" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="d-block d-lg-none py-9 py-xl-0">
                <img src="<?= base_url('assets/images/logos/logo.svg'); ?>" alt="matdash-img" />
            </div>
                    ...
                    <ul class="navbar-nav flex-row mx-auto ms-lg-auto align-items-center justify-content-center">
                        ...
                        <li class="nav-item dropdown nav-icon-hover-bg rounded-circle">
                            <a class="nav-link" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="<?= base_url('assets/images/flag/icon-flag-en.svg'); ?>" alt="matdash-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20" />
                            </a>
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                                <div class="message-body">
                                    ...
                                    <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                        <div class="position-relative">
                                            <img src="<?= base_url('assets/images/flag/icon-flag-cn.svg'); ?>" alt="matdash-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20" />
                                        </div>
                                        <p class="mb-0 fs-3">中国人 (Chinese)</p>
                                    </a>
                                    <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                        <div class="position-relative">
                                            <img src="<?= base_url('assets/images/flag/icon-flag-fr.svg'); ?>" alt="matdash-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20" />
                                        </div>
                                        <p class="mb-0 fs-3">français (French)</p>
                                    </a>
                                    <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                        <div class="position-relative">
                                            <img src="<?= base_url('assets/images/flag/icon-flag-sa.svg'); ?>" alt="matdash-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20" />
                                        </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="javascript:void(0)" id="drop1" aria-expanded="false">
                                <div class="d-flex align-items-center gap-2 lh-base">
                                    <img src="<?= base_url('assets/images/profile/user-1.jpg'); ?>" class="rounded-circle" width="35" height="35" alt="matdash-img" />
                            ...
                            <div class="dropdown-menu profile-dropdown dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
                                <div class="position-relative px-4 pt-3 pb-2">
                                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom gap-6">
                                        <img src="<?= base_url('assets/images/profile/user-1.jpg'); ?>" class="rounded-circle" width="56" height="56" alt="matdash-img" />
                                        <div>
                                            <h5 class="mb-0 fs-12"><?= isset($user) && $user ? esc($user->username) : 'Admin'; ?> <span class="text-success fs-11">Pro</span>
                                            </h5>
                                            <p class="mb-0 text-dark">
                                                <?= isset($user) && $user ? esc($user->email) : 'admin@e-asfarm.com'; ?>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="message-body">
                                        <a href="<?= base_url('assets/default-sidebar/page-user-profile.html'); ?>" class="p-2 dropdown-item h6 rounded-1">
                                            My Profile
                                        </a>
                                        <a href="<?= base_url('assets/default-sidebar/page-pricing.html'); ?>" class="p-2 dropdown-item h6 rounded-1">
                                            My Subscription
                                        </a>
                                        <a href="<?= base_url('assets/default-sidebar/app-invoice.html'); ?>" class="p-2 dropdown-item h6 rounded-1">
                                            My Invoice <span class="badge bg-danger-subtle text-danger rounded ms-8">4</span>
                                        </a>
                                        <a href="<?= base_url('assets/default-sidebar/page-account-settings.html'); ?>" class="p-2 dropdown-item h6 rounded-1">
                                            Account Settings
                                        </a>
                                        <a href="<?= base_url('assets/default-sidebar/authentication-login2.html'); ?>" class="p-2 dropdown-item h6 rounded-1">
                                            Sign Out
                                        </a>
                                    </div>
                                </div>
        ...
        <div class="offcanvas offcanvas-start pt-0" data-bs-scroll="true" tabindex="-1" id="mobilenavbar" aria-labelledby="offcanvasWithBothOptionsLabel">
            <nav class="sidebar-nav scroll-sidebar">
                <div class="offcanvas-header justify-content-between">
                    <a href="<?= base_url('assets/default-sidebar/index.html'); ?>" class="text-nowrap logo-img">
                        <img src="<?= base_url('assets/images/logos/logo-icon.svg'); ?>" alt="Logo" />
                    </a>
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level my-3 ps-3">
                                <li class="sidebar-item py-2">
                                    <a href="<?= base_url('assets/default-sidebar/app-chat.html'); ?>" class="d-flex align-items-center">
                                        <div class="bg-primary-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                            <iconify-icon icon="solar:chat-line-bold-duotone" class="fs-7 text-primary"></iconify-icon>
                                        </div>
                                        <div class="d-inline-block">
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="<?= base_url('assets/default-sidebar/app-invoice.html'); ?>" class="d-flex align-items-center">
                                        <div class="bg-secondary-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                            <iconify-icon icon="solar:bill-list-bold-duotone" class="fs-7 text-secondary"></iconify-icon>
                                        </div>
                                        <div class="d-inline-block">
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="<?= base_url('assets/default-sidebar/app-contact2.html'); ?>" class="d-flex align-items-center">
                                        <div class="bg-warning-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                            <iconify-icon icon="solar:phone-calling-rounded-bold-duotone" class="fs-7 text-warning"></iconify-icon>
                                        </div>
                                        <div class="d-inline-block">
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="<?= base_url('assets/default-sidebar/app-email.html'); ?>" class="d-flex align-items-center">
                                        <div class="bg-danger-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                            <iconify-icon icon="solar:letter-bold-duotone" class="fs-7 text-danger"></iconify-icon>
                                        </div>
                                        <div class="d-inline-block">
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="<?= base_url('assets/default-sidebar/page-user-profile.html'); ?>" class="d-flex align-items-center">
                                        <div class="bg-success-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                            <iconify-icon icon="solar:user-bold-duotone" class="fs-7 text-success"></iconify-icon>
                                        </div>
                                        <div class="d-inline-block">
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="<?= base_url('assets/default-sidebar/app-calendar.html'); ?>" class="d-flex align-items-center">
                                        <div class="bg-primary-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                            <iconify-icon icon="solar:calendar-minimalistic-bold-duotone" class="fs-7 text-primary"></iconify-icon>
                                        </div>
                                        <div class="d-inline-block">
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="<?= base_url('assets/default-sidebar/app-contact.html'); ?>" class="d-flex align-items-center">
                                        <div class="bg-secondary-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                            <iconify-icon icon="solar:smartphone-2-bold-duotone" class="fs-7 text-secondary"></iconify-icon>
                                        </div>
                                        <div class="d-inline-block">
                                ...
                                <li class="sidebar-item py-2">
                                    <a href="<?= base_url('assets/default-sidebar/app-notes.html'); ?>" class="d-flex align-items-center">
                                        <div class="bg-warning-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                            <iconify-icon icon="solar:notes-bold-duotone" class="fs-7 text-warning"></iconify-icon>
                                        </div>
                                        <div class="d-inline-block">
        ...
        <nav class="navbar navbar-expand-xl container-fluid p-0">
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item d-none d-xl-flex align-items-center">
                    <a href="<?= base_url('assets/horizontal/index.html'); ?>" class="text-nowrap nav-link">
                        <img src="<?= base_url('assets/images/logos/logo.svg'); ?>" alt="matdash-img" />
                    </a>
                </li>
                                    ...
                                    <div class="col-8">
                                        <div class="p-4 pb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="position-relative">
                                                        <a href="<?= base_url('assets/default-sidebar/app-chat.html'); ?>" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="bg-primary-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                                                <iconify-icon icon="solar:chat-line-bold-duotone" class="fs-7 text-primary"></iconify-icon>
                                                            </div>
                                                            <div class="d-inline-block">
                                                        ...
                                                        <a href="<?= base_url('assets/default-sidebar/app-invoice.html'); ?>" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="bg-secondary-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                                                <iconify-icon icon="solar:bill-list-bold-duotone" class="fs-7 text-secondary"></iconify-icon>
                                                            </div>
                                                            <div class="d-inline-block">
                                                        ...
                                                        <a href="<?= base_url('assets/default-sidebar/app-contact2.html'); ?>" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="bg-warning-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                                                <iconify-icon icon="solar:phone-calling-rounded-bold-duotone" class="fs-7 text-warning"></iconify-icon>
                                                            </div>
                                                            <div class="d-inline-block">
                                                        ...
                                                        <a href="<?= base_url('assets/default-sidebar/app-email.html'); ?>" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="bg-danger-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                                                <iconify-icon icon="solar:letter-bold-duotone" class="fs-7 text-danger"></iconify-icon>
                                                            </div>
                                                            <div class="d-inline-block">
                                                ...
                                                <div class="col-6">
                                                    <div class="position-relative">
                                                        <a href="<?= base_url('assets/default-sidebar/page-user-profile.html'); ?>" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="bg-success-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                                                <iconify-icon icon="solar:user-bold-duotone" class="fs-7 text-success"></iconify-icon>
                                                            </div>
                                                            <div class="d-inline-block">
                                                        ...
                                                        <a href="<?= base_url('assets/default-sidebar/app-calendar.html'); ?>" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="bg-primary-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                                                <iconify-icon icon="solar:calendar-minimalistic-bold-duotone" class="fs-7 text-primary"></iconify-icon>
                                                            </div>
                                                            <div class="d-inline-block">
                                                        ...
                                                        <a href="<?= base_url('assets/default-sidebar/app-contact.html'); ?>" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="bg-secondary-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                                                <iconify-icon icon="solar:smartphone-2-bold-duotone" class="fs-7 text-secondary"></iconify-icon>
                                                            </div>
                                                            <div class="d-inline-block">
                                                        ...
                                                        <a href="<?= base_url('assets/default-sidebar/app-notes.html'); ?>" class="d-flex align-items-center pb-9 position-relative">
                                                            <div class="bg-warning-subtle rounded round-48 me-3 d-flex align-items-center justify-content-center">
                                                                <iconify-icon icon="solar:notes-bold-duotone" class="fs-7 text-warning"></iconify-icon>
                                                            </div>
                                                            <div class="d-inline-block">
            ...
            <div class="d-block d-xl-none">
                <a href="<?= base_url('assets/default-sidebar/index.html'); ?>" class="text-nowrap nav-link">
                    <img src="<?= base_url('assets/images/logos/logo.svg'); ?>" alt="matdash-img" />
                </a>
            </div>
