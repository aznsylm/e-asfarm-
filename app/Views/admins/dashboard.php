                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-3 mb-9 justify-content-between align-items-center">
                            <h5 class="card-title fw-semibold mb-0">Dashboard Admin - Selamat datang <?= esc($user->username) ?>!</h5>
                        ...
                        <?php
                        // Daftar kategori dan ikon yang sesuai
                        $categories = [
                            'Farmasi' => 'solar:atom-outline',
                            'Gizi' => 'solar:pills-3-line-duotone',
                            'Bidan' => 'solar:pipette-line-duotone'
                        ];
                        ?>
                        ...
                        <div class="table-responsive">
                            <ul class="nav nav-tabs theme-tab gap-3 flex-nowrap" role="tablist">
                                <?php foreach ($categories as $category => $icon): ?>
                                    <li class="nav-item">
                                        <a class="nav-link <?= ($category == 'Farmasi') ? 'active' : ''; ?>" data-bs-toggle="tab" href="#<?= strtolower($category); ?>" role="tab">
                                            <div class="hstack gap-2">
                                                <iconify-icon icon="<?= $icon; ?>" class="fs-4"></iconify-icon>
                                                <span><?= $category; ?></span>
                                            </div>
                                        </a>
                                    </li>
                        ...
                        <div class="tab-content mb-n3">
                            <?php foreach ($categories as $category => $icon): ?>
                                <div class="tab-pane <?= ($category == 'Farmasi') ? 'active' : ''; ?>" id="<?= strtolower($category); ?>" role="tabpanel">
                                    <div class="table-responsive" data-simplebar>
                                        <table class="table text-nowrap align-middle table-custom mb-0 last-items-borderless">
                                            <thead>
                                                <tr>
                                                    <th scope="col" class="fw-normal ps-0">Judul</th>
                                                    <th scope="col" class="fw-normal">Progress</th>
                                                    <th scope="col" class="fw-normal">Kategori</th>
                                                    <th scope="col" class="fw-normal">Pinjau</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                // Pastikan data ada dan cocok dengan kategori
                                                        ...
                                                        <tr>
                                                            <td class="ps-0">
                                                                <div class="d-flex align-items-center gap-6">
                                                                    <img src="<?= base_url('assets/images/blog/' . $data['image']) ?>" alt="<?= esc($data['title']) ?>" width="48" class="rounded" />
                                                                    <div>
                                                                        <h6 class="mb-0"><?= substr($data['title'], 0, 40); ?></h6>
                                                                        <span>Jason Roy</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td><span>Publis</span></td>
                                                            <td>
                                                                <span class="badge <?= ($data['category'] == 'Farmasi') ? 'bg-primary-subtle text-primary' : (($data['category'] == 'Gizi') ? 'bg-info-subtle text-info' : 'bg-warning-subtle text-warning'); ?>"><?= $data['category']; ?></span>
                                                            </td>
                                                            <td>
                                                                <a href="/admin/pinjau-artikel/<?= $data['id']; ?>" class="d-flex align-items-center gap-3">
                                                                    <iconify-icon icon="solar:eye-bold-duotone" class="fs-4"></iconify-icon>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                <?php
                                                ...
                                                if (!$categoryExists):
                                                    echo "<tr><td colspan='4' class='text-center'>Tidak ada artikel di kategori ini.</td></tr>";
                                                endif;
                                                ?>
                                            </tbody>
                                        </table>
