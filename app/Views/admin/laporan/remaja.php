        ...
        <div class="col-12">
            <div class="card border-warning">
                <div class="card-body text-center py-5">
                    ...
                    <p class="text-muted">Halaman laporan statistik remaja sedang dalam tahap pengembangan.</p>
